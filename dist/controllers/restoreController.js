...
exports.restoreDB = (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        let result = yield restoreService_1.restoreToDB();
        default_response_1.successResponse(res, { done: 'done' });
    }
    catch (err) {
